...
//            log.infor("Email sent successfully to {}", to);
            System.out.println("Email sent successfully to {}" + to);

        }catch(MessagingException e){
//            log.error("Failed to send email to {}", to, e);
            System.out.println("Failed to send email to {}" + to + e);
    ...
    public void sendEmailWithTemplate(String to, String subject, String templateName, Map<String, Object> placeholders, File attachment){
        try{
            Template template = configFreeMaker.getTemplate(templateName);
            String html = FreeMarkerTemplateUtils.processTemplateIntoString(template, placeholders); // handle template to String
            ...
            javaMailSender.send(message);
//            log.infor("Email sent successfully to {}", to);
            System.out.println("EmailWithTemplate sent successfully to {}" + to);
        }catch(MessagingException | IOException | TemplateException e){
//            log.error("Failed to send email to {}", to, e);
            System.out.println("Failed to send EmailWithTemplate to {}" + to + e);
        }
    }
